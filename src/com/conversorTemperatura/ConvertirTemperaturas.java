...
/**
 *Calculo de las conversiones, se utilizaron las temperaturas Celsius, Fahrenheit,
 * Kelvin y Rankine
 */
public class ConvertirTemperaturas {
    ...
    public void ConvertirCelsiusRankine(double valor) {
        ...
        JOptionPane.showMessageDialog(null, "Son " + CRankine + " grados Rankine");
    }
    ...
    public void ConvertirFahrenheitKelvin(double valor) {
        ...
        JOptionPane.showMessageDialog(null, "Son " + FKelvin + " grados Kelvin");
    }
    ...
    public void ConvertirFahrenheitRankine(double valor) {
        ...
        JOptionPane.showMessageDialog(null, "Son " + FRankine + " grados Rankine");
    }
    ...
    public void ConvertirKelvinFahrenheit(double valor) {
        ...
        JOptionPane.showMessageDialog(null, "Son " + KFahrenhit + " grados Fahrenheit");
    }

    public void ConvertirKelvinRankine(double valor) {
        double KRankine = valor * 1.8;
        KRankine = (double) Math.round(KRankine * 100d) / 100;
        JOptionPane.showMessageDialog(null, "Son " + KRankine + " grados Rankine");
    }
    ...
    public void ConvertirRankineCelsius(double valor) {
        ...
        JOptionPane.showMessageDialog(null, "Son " + RCelsius + " grados Celsius");
    }
    ...
    public void ConvertirRankineFahrenheit(double valor) {
        ...
        JOptionPane.showMessageDialog(null, "Son " + RFahrenhit + " grados Fahrenheit");
    }

    public void ConvertirRankineKelvin(double valor) {
        double RKelvin = valor * (0.556);
        RKelvin = (double) Math.round(RKelvin * 100d) / 100;
        JOptionPane.showMessageDialog(null, "Son " + RKelvin + " grados Kelvin");
    }
}
