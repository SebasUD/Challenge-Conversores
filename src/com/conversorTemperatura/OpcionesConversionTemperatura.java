...
/**
 * De igual forma como el conversor de monedas se utilizó el JOptioPane y una matriz de 
 * objetos para crear el menú del conversor de temperaturas.
 */
public class OpcionesConversionTemperatura {
    ...
    public void ConvertirTemperaturas(double valor) {
        ...
        String opcion = (JOptionPane.showInputDialog(null,
                ...
                JOptionPane.PLAIN_MESSAGE, null, new Object[]{"De Celsius a Fahrenheit", 
                    "De Celsius a Kelvin", 
